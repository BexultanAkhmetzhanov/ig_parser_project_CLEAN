...
from categories.views import CategoryViewSet, SubcategoryViewSet, CategoryWithSubcategoriesView
...
urlpatterns = [
    path('', RedirectView.as_view(url='https://promo-finder.netlify.app/', permanent=False)), 
